...
# send request to API
def send(endpoint, user_message, stream, max_tokens, temperature, top_p, top_k, repeat_penalty, stop, system_content, content_container):
    #system_content = base.get_rag(system_content_base, user_message)
    #print st.success(system_content)
    ...
    #return st.success(system_content)
